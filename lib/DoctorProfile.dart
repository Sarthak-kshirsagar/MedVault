...
class DoctorInfo extends StatefulWidget {
  ...
  String specialization = '';
   ...
   DoctorInfo({required this.doctorId,required this.doctorName, required this.specialization});
    ...
    return Scaffold(
        body: Stack(
          children: [
            Container(
              child: Image.network(
                'https://blogimages.softwaresuggest.com/blog/wp-content/uploads/2021/05/10192350/Top-8-Benefits-of-Having-A-Smart-Hospital-Management-System.png',
                height: 340,
                      ...
                      child: Column(
                        children: [
                          ...
                          Wrap(
                            children: [
                              Text(
                                'Dr. ${widget.doctorName} is the top most heart surgeon in Apollo Hospital. He has done over 100 Sucessful surgeries within past 3 years. He has achieved several awards for his wonderful contribution in his own field. He\'s available for private consultation for given schedules.',
                                style: TextStyle(
